...
const Hero: React.FC<HeroProps> = ({ language, onBookingClick }) => {
  const content = {
    en: {
      ...
      description: "A state-of-the-art convention centre dedicated to promoting Telugu arts, culture, and heritage. Perfect venue for cultural festivals, art exhibitions, classical performances, and government functions.",
      bookNow: "Book Your Event",
      contact: "Contact Us",
      features: [
        "Cultural Heritage Venue",
        "Government Approved",
        "Modern Facilities",
    ...
    te: {
      ...
      description: "తెలుగు కళలు, సంస్కృతి మరియు వారసత్వాన్ని ప్రోత్సహించడానికి అంకితమైన అత్యాధునిక కన్వెన్షన్ సెంటర్. సాంస్కృతిక ఉత్సవాలు, కళా ప్రదర్శనలు, శాస్త్రీయ ప్రదర్శనలు మరియు ప్రభుత్వ కార్యక్రమాలకు పరిపూర్ణ వేదిక.",
      bookNow: "మీ కార్యక్రమాన్ని బుక్ చేయండి",
      contact: "మమ్మల్ని సంప్రదించండి",
      features: [
        "సాంస్కృతిక వారసత్వ వేదిక",
        "ప్రభుత్వ ఆమోదం",
        "ఆధునిక సౌకర్యాలు",
        "వృత్తిపరమైన సేవలు"
      ]
...
<section className="relative min-h-screen flex items-start justify-start pt-24">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            {/* Right Content - Stats */}
            <div className="mt-8 lg:mt-0 lg:absolute lg:right-8 lg:bottom-20 lg:w-[420px] lg:text-right lg:z-20">
